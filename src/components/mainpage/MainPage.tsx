...
const MainPage = () => {
  ...
  return (
    <>
      <Helmet>
        {/* Meta tags for SEO */}
        <title>Design Forms, Collect Insights - Shape the Future</title>
        <meta
          name="description"
          content="Effortlessly create, share, and analyze forms with our intuitive platform. From surveys to feedback, our app simplifies every step, helping you gather insights in real-time."
        />
        <meta
          name="keywords"
          content="forms, surveys, feedback, insights, data collection"
        />

        <meta
          property="og:title"
          content="Design Forms, Collect Insights - Shape the Future"
        />
        <meta
          property="og:description"
          content="Create and analyze forms with ease using our intuitive platform. Real-time insights, built for your needs."
        />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 h-[93vh] overflow-hidden">
        ...
        <div className="relative pt-20 2xl:pt-32 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            ...
            {user && (
              <Button className="my-4" onClick={() => navigate(path.dashboard)}>
                Start Building
              </Button>
            )}
            {!user && (
              <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
                <div
                  className="relative flex h-11 w-56  items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
                ...
                <div className="relative flex h-11  w-56  items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:border before:border-transparent before:bg-primary/10 before:bg-gradient-to-b before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-gray-800 sm:w-max">
