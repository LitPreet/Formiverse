...
const FormView = () => {
  ...
  return (
    <>
      <Helmet>
        {/* Meta tags for SEO */}
        <title>Edit Form - View Responses & Send Links</title>
        <meta
          name="description"
          content="Edit your form, view user responses, and send the form link to others via email. Manage everything seamlessly from this page."
        />
        <meta
          name="keywords"
          content="edit form, form responses, send form link, email form link"
        />

        {/* Open Graph Meta Tags for Social Media */}
        <meta
          property="og:title"
          content="Edit Form - View Responses & Send Links"
        />
        <meta
          property="og:description"
          content="Edit your forms and view user responses in real-time. Easily send form links via email for users to participate."
        />
